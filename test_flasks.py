...
class TriviaTestCase(unittest.TestCase):
    ...
    '''
    test invalid token for get, post, patch, delete, and authorization
    '''

    def test_castings_missing_token(self):
        token = "Bearer "
    ...
    def test_castings_invalid_token(self):
        # Invalid
    ...
    '''
    producer PATCH movies and castings list,topgun,id 17,
    Monica Anna Maria Bellucci,id6
    '''
